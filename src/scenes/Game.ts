...
export class Game extends Scene {
    ...
    create() {
        ...
        // Extra visuals
        const label = this.add.text(300, 500, 'Funky shadows', { fontSize: '36px', fill: '#fff' });
    ...
    renderLight(pointer: Phaser.Input.Pointer) {
        ...
        let { transparencies, quad } = this.createLightPolygon(pointer.x, pointer.y);
    ...
    drawLightTriangles(visibility: [number, number][], transparencies: number[]) {
        ...
        for (let i = 0; i < visibility.length - 4; i += 4) {
            ...
            this.triangleGraphics.fillGradientStyle(
                color3,
                color2,
                color1,
                0,
            ...
            this.triangleGraphics.fillTriangle(three.x, three.y, two.x, two.y, one.x, one.y,);
            ...
            this.triangleGraphics.fillTriangle(one.x, one.y, three.x, three.y, four.x, four.y,);
        }
    }
